...
import In from '../assets/Instagram_icon.png'
import Tw from '../assets/twitter_3256013.png'
function Footer() {
  return (
    <div className='w-full flex  h-screen bg-zinc-900 px-[4vw] py-20 '>
        <div className='left flex flex-col justify-between w-1/2 h-full font-serif'>
            <div className='eyeopening'>
                <h1   className='uppercase text-[6vw] font-semibold leading-none -mb-4 '>eye-</h1>    
                <h1  className='uppercase text-[6vw] font-semibold leading-none  -mb-4 '>opening</h1>
            </div>
            <div className='ochi'>
        ...
        <div className='right w-1/2 h-full  font-serif '>
        <div className='presentations '>
            <h1   className='uppercase text-[5vw] font-semibold leading-none -mb-4 '>presentations</h1>         
            <div className=' font-semibold  gap-3 italic mt-[40vh] flex flex-col'>
                <a href="https://www.facebook.com/" target='_blank'><img className='w-13 -ml-1' src={Fb} alt="facebook" /> </a>
                <a href="https://www.instagram.com/" target='_blank'><img className='w-10' src={In} alt="instagram" /> </a>
                <a href="https://www.twitter.com/" target='_blank'><img className='w-10' src={Tw} alt="twitter" /> </a>
